...
-- alterado para meu banco
-- Inserir avaliações
call insert_reviews(25, 33, 5, 'Amazing book! A must-read for everyone.');
call insert_reviews(26, 34, 4, 'Great start to an epic series, though a bit slow at times.');
call insert_reviews(27, 35, 5, 'A timeless classic. Loved every part of it.');
call insert_reviews(28, 36, 4, 'A masterpiece of science fiction, though the pace was a bit uneven.');
call insert_reviews(26, 34, 4, 'Enjoyable, but not as great as the later books in the series.');
call insert_reviews(28, 36, 5, 'Read it multiple times, and it never gets old.');
call insert_reviews(25, 33, 5, 'Incredible world-building. Can’t wait to read the next book.');
call insert_reviews(27, 35, 3, 'Interesting ideas, but some parts felt outdated.');
